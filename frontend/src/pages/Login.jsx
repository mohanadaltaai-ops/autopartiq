...
export default function Login() {
  ...
  function renderLanding() {
    return (
      <div className="flex-1 flex flex-col bg-[#F5F7FC]">
        <div className="px-7 pt-24 pb-5">
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 rounded-[22px] bg-white border border-slate-200 shadow-sm flex items-center justify-center overflow-hidden">
              <img src={logo} alt={appName} className="w-12 h-12 object-contain" />
            </div>
            <div>
              <div className="text-[28px] font-black tracking-tight text-[#081B4B]">{appName}</div>
              <div className="text-[12px] font-bold text-[#8B95A7]">{copy.market}</div>
            </div>
          </div>
          ...
          <div className="mt-7 rounded-[30px] bg-white border border-slate-200 shadow-sm p-4">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-[11px] font-black text-[#F97316] tracking-[0.18em]">LIVE QUOTE</div>
                <div className="text-[22px] font-black text-[#081B4B] mt-1">{copy.partName}</div>
              </div>
              <div className="text-right">
                <div className="text-[18px] font-black text-[#27439C]">{copy.price}</div>
                <div className="text-[11px] font-black text-[#8B95A7] mt-1">{copy.offers}</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="px-7 pt-24 pb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="text-[12px] font-bold text-[#8B95A7]">{copy.emailTitle}</div>
            </div>
          </div>
        </div>
        ...
        <div className="px-6 pb-6 flex-1 flex flex-col justify-center gap-4">
          ...
          {!magicSent ? (
            <>
              <div className="bg-white rounded-[24px] border border-slate-200 shadow-sm p-3">
                <input
                  ...
                  inputMode="email"
                  type="email"
                  className="w-full h-14 px-4 rounded-[18px] bg-[#F8FAFD] border border-slate-200 outline-none text-[16px] font-bold text-left placeholder:text-left"
                  value={email}
                  onChange={e => {
            ...
            <button
              ...
              className="w-full h-14 rounded-[18px] bg-white border border-slate-200 text-[#27439C] font-black text-[15px]"
            >
              {copy.sendAnotherMagic}
            </button>
          )}

          <button onClick={() => setScreen('landing')} className="text-[#8B95A7] text-sm font-bold">
            {copy.back}
          </button>
        ...
        <div className="px-6 pb-6 flex-1 flex flex-col justify-center gap-4">
          ...
          {screen === 'phone' ? (
            ...
            <>
              ...
              <button onClick={() => setScreen('phone')} className="text-[#8B95A7] text-sm font-bold">
                {copy.changeNumber}
              </button>
            </>
          )}
